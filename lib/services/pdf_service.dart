...
Future<void> generateAndShareBill(ProductResponse billData) async {
        ...
        return pw.Column(
          ...
          children: [
            ...
            pw.Container(
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    pw.SizedBox(height: 6),
                    ...billData.productData?.map((item) => pw.Column(
                          crossAxisAlignment: pw.CrossAxisAlignment.start,
                          children: [
                            pw.Row(
                              mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                            ...
                            pw.Row(
                              mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                              children: [
                                pw.Text(isOpticalTemplate ? 'Frame Price:' : "Qty:",
                                    style: pw.TextStyle(fontWeight: pw.FontWeight.normal)),
                                pw.Text(isOpticalTemplate
                                    ? item.framePrice.validate(value: '0')
                                    : item.qty.validate(value: '1'),
                                    style: pw.TextStyle(fontWeight: pw.FontWeight.normal)),
                              ],
                            ),
                            pw.Row(
                              mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                              children: [
                                pw.Text("Discount:", style: pw.TextStyle(fontWeight: pw.FontWeight.normal)),
                                pw.Text('${item.discount.validate(value: "0")}%',
                                    style: pw.TextStyle(fontWeight: pw.FontWeight.normal)),
                              ],
                            ),
                            pw.Row(
                              ...
                              children: [
                                pw.Text('Total:',
                                    style: pw.TextStyle(fontWeight: pw.FontWeight.normal)),
                                pw.Text(item.totalAmount.validate(value: "0"),
                                    style: pw.TextStyle(fontWeight: pw.FontWeight.normal)),
                              ],
                            ),
                          ],
            ...
            pw.Container(
              padding: const pw.EdgeInsets.all(10),
              decoration: pw.BoxDecoration(
                  border: pw.Border.all(color: const PdfColor.fromInt(0xFF000000)),
                  borderRadius: pw.BorderRadius.circular(8)),
              child: pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [
  ...
  final file = File('${output.path}/Bill_${billData.customerDetails?.billNumber}.pdf');
  await file.writeAsBytes(await pdf.save());

  print('Sharing PDF...');
  await Share.shareXFiles([XFile(file.path)], subject: 'Bill ${billData.customerDetails?.billNumber}');
